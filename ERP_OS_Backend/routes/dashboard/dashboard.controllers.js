...
const getDashboardData = async (req, res) => {
  try {
    ...
    const formattedData4 = [
      { type: "sales", value: salesInfo._sum.total_amount },
    ];
    const formattedData5 = [
      { type: "purchases", value: purchasesInfo._sum.total_amount },
    ];
    ...
    const cardInfo = {
      ...
      purchase_total: purchaseInfo._sum.total_amount,
      sale_count: saleInfo._count.id,
      sale_total: saleInfo._sum.total_amount,
      sale_profit: saleInfo._sum.profit,
    };
    res.json({
      saleProfitCount,
      SupplierVSCustomer,
